...
cv_clf = cv_clf = AdaBoostClassifier()
...
yscore_sum.to_csv('yscore_sum_Ada_GPCR_Lasso_SMOTE.csv')
ytest=ytest[np.array(range(1,row)),:]
ytest_sum = pd.DataFrame(data=ytest)
ytest_sum.to_csv('ytest_sum_Ada_GPCR_Lasso_SMOTE.csv')
...
data_csv.to_csv('Ada_GPCR_Lasso_SMOTE.csv')
