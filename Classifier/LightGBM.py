...
cv_clf = lgb.LGBMClassifier(n_estimators=500,max_depth=7,learning_rate=0.1)
...
yscore_sum.to_csv('yscore_sum_LGB_GPCR_Lasso_SMOTE.csv')
ytest=ytest[np.array(range(1,row)),:]
ytest_sum = pd.DataFrame(data=ytest)
ytest_sum.to_csv('ytest_sum_LGB_GPCR_Lasso_SMOTE.csv')
...
data_csv.to_csv('LGB_GPCR_Lasso_SMOTE.csv')
